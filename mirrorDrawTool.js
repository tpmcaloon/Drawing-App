function MirrorDrawTool() {
	...
	this.draw = function() 
	{
		...
		{
			updatePixels(); //display the last save state of pixels
			
			if (mouseIsPressed) //do the drawing if the mouse is pressed
			{
				...
				if (previousMouseX == -1) //if the previous values are -1 set them to the current mouse location and mirrored positions
				{
				...
				else //if there are values in the previous locations draw a line between them and the current positions
				{
